...
const FormDeleteModalAdmin = ({ onClose, id, setIsLoading }) => {
  ...
  return (
    <form className="form_modal">
      <h1 className="text-2xl text-center">Hapus Admin</h1>
      ...
      <section className="flex flex-col items-center gap-2 w-full justify-center">
        <p>Anda yakin ingin menghapus Admin</p>
...
export default FormDeleteModalAdmin;
