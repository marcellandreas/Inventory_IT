...
const AdminDetailFormItemsRequest = () => {
  ...
  const handleUpdateStatus = () => {
    AxiosInstance.put(`/form/status/${id_item_req}`, {
      status: "approved_1",
    }).then(() => {
      alert("berhasil");
    });
          ...
          <div className="flex justify-between">
            ...
            {role == 1 || role == 3 ? (
              <div className="flex gap-3">
                <button onClick={handleUpdateStatus} className="button">
                  Setuju
                </button>
                <button onClick={handleUpdateStatusReject} className="button">
                  Tolak
                </button>
              </div>
            ) : null}
...
export default AdminDetailFormItemsRequest;
