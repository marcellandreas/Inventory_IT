  ...
  return (
    <section className=" col-span-6 min-h-screen ">
      ...
      >
        ...
        <section className=" absolute left-1/2 top-[180%] sm:top-[100%] transform -translate-x-1/2 -translate-y-1/2   col-span-6 w-full grid grid-cols-4 gap-4 grid-flow-dense  justify-between  ">
          <Widget
            icon={<ImBooks />}
      ...
      <section className="mt-[150%] sm:mt-28  grid grid-cols-4 gap-4 grid-flow-dense ">
